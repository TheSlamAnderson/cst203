...
calendar::calendar(int mm, int yyyy)
{
   ...
   if (mm < 1 || mm > 12)
		cout << "calendar constructor: " << mm << "invalid month";

   if (yyyy < 1900)
		cout << "calendar constructor:" << yyyy<< "is prior to 1900";
...
void calendar::setMonth(int mm)
{
   ...
   if (mm < 1 || mm > 12)
		cout << "calendar setMonth(): " <<mm<<"invalid month";
...
void calendar::setYear(int yyyy)
{
   ...
   if (yyyy < 1900)
		cout <<"calendar setYear():"<< yyyy <<"is prior to 1900";
