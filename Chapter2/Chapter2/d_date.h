...
{
   if (month < 1 || month > 12)
	   cout << "Error: date constructor: "<< month << "invalid month";

   if (day <= 0 || day > daysInMonth())
	   cout << "Error: date constructor: " << day <<"invalid day of month";
}
...
void date::incrementDate(int ndays)
{
   ...
   if (ndays < 0 || ndays > 365)
	   cout << "dateError: " << ndays << "is out of range";
...
void date::setMonth(int mm)
{
   ...
   if (mm < 1 || mm > 12)
		cout << "date setMonth(): " << mm <<" invalid month";
...
void date::setDay(int dd)
{
   ...
   if (dd <= 0 || dd > daysInMonth())
		cout << "date setDay(): " << dd <<" invalid day of month";
...
void date::setYear(int yyyy)
{
   ...
   if (month == 2 && day == 29 && !isLeapYear())
		cout << "date setYear(): "<< year << "Not a leap year. February 29 invalid";
}
